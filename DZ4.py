...
Students = [Student('Сергей', 'Угрюмов', 'your_gender'),
            Student('Александр', 'Мосиенков', 'your_gender')]
...
Lecturers = [Lecturer('Антон', 'Плиско'),
             Lecturer('Дмитрий', 'Саматов')]
Lecturers[0].courses_attached += ['Python']
Lecturers[0].courses_attached += ['Java']
Lecturers[1].courses_attached += ['JS']

Reviewers = [Reviewer('Игорь', 'Кандрашов'),
             Reviewer('Анна', 'Савина')]
